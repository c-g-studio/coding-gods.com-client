  ...
  return (
    ...
    >
      ...
      <div className="container flex flex-col">
        ...
        <span className="text-orange-450 absolute top-[665.72] z-10 font-bungee text-[34.54px] opacity-10 md:top-[310.71px] md:text-[84.311px] lg:top-[198px] lg:text-[128px] xl:top-[160px] xl:text-[160px]">
          CODING GODS
        </span>
        <div className="bg-orange-450 h-[1px] w-full"></div>
